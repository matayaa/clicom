...
CREATE DATABASE IF NOT EXISTS `clicom` /*DEFAULT CHARACTER SET latin1*/;
...
INSERT INTO `client` (`cli_id`, `cli_prenom`, `cli_nom`, `cli_email`, `cli_ville`, `cli_password`) VALUES
(1, 'Muriel', 'Da costa', 'f.da.costa@example.com', 'Pomoy', 'b444ac06613fc8d63795be9ad0beaf55011936ac'),
...
CREATE TABLE IF NOT EXISTS `commande` (
  ...
  `com_cli_id` int(10) UNSIGNED NOT NULL,
  `com_date_achat` date NOT NULL,
  `com_reference` varchar(255) NOT NULL,
  `com_cache_prix_total` float NOT NULL,
  PRIMARY KEY (`com_id`),
  KEY `com_cli_id` (`com_cli_id`),
  CONSTRAINT `client_ibfk_1` FOREIGN KEY (`com_cli_id`) REFERENCES `client` (`cli_id`)
...
INSERT INTO `commande` (`com_id`, `com_cli_id`, `com_date_achat`, `com_reference`, `com_cache_prix_total`) VALUES
...
CREATE TABLE IF NOT EXISTS `commande_ligne` (
  `com_lig_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `com_lig_com_id` int(10) UNSIGNED NOT NULL,
  `com_lig_nom` varchar(255) NOT NULL,
  `com_lig_quantite` int(10) UNSIGNED NOT NULL,
  `com_lig_prix_unitaire` float UNSIGNED NOT NULL,
  `com_lig_prix_total` float UNSIGNED NOT NULL,
  PRIMARY KEY (`com_lig_id`),
  KEY `com_lig_com_id` (`com_lig_com_id`),
  CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`com_lig_com_id`) REFERENCES `commande` (`com_id`)
...
INSERT INTO `commande_ligne` (`com_lig_id`, `com_lig_com_id`, `com_lig_nom`, `com_lig_quantite`, `com_lig_prix_unitaire`, `com_lig_prix_total`) VALUES
